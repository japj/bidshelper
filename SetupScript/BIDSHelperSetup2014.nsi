...
Section "MainSection" SEC01
  ...
  ${Else}
	  ...
	  CreateDirectory "$PROGRAMFILES\Microsoft Visual Studio 12.0\Xml\Schemas"
	  File "/oname=$PROGRAMFILES\Microsoft Visual Studio 12.0\Xml\Schemas\Biml.xsd" "..\bin\DLLs\Biml\Biml.xsd"
  ${EndIf}
